...
public class MeasurementController {
	...
	public ResponseEntity<MeasurementEntity> createMeasurement(@RequestBody MeasurementRequestDto measurementRequestDto) {
		return ResponseEntity.ok(measurementService.addMeasurement(measurementRequestDto));
	}
